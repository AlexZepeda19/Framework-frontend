                        ...
                        <nav className="navbar navbar-expand-lg navbar-light bg-light mb-4">
                            ...
                            <div className="collapse navbar-collapse" id="navbarNav">
                                <ul className="navbar-nav">
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link" href="/Categorias">Administrar Categorías</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" href="/Usuarios">Administrar Usuarios</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" href="/Roles">Administrar Roles</a>
                                    </li>
                                    <li className="nav-item">
